...
import static to.msn.wings.oekakiapp.R.id.button_sign;
...
//                Toast.makeText(getApplication(), n , Toast.LENGTH_SHORT).show();
                ...
                SnN = mUserName.getText().toString();
                SnM = mEmail.getText().toString();
                ...
                user.signUpInBackground(new SignUpCallback() {
                    ...
                    public void done(NCMBException e) {
                        if (e == null) {
                            ...
                            intent.putExtra("sign_up_Name",SnN);
                            intent.putExtra("sign_up_Em", SnM);
                            startActivity(intent);
